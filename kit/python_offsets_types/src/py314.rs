/* automatically generated by rust-bindgen 0.72.1, updated for v3.14.3 */

//! CPython `_Py_DebugOffsets` layout for `v3.14.3`.
//!
//! Originally auto-generated by `gen_debug_offsets.sh v3.14.0b1 py314`.
//! Updated to match the 3.14.3 release layout (added fields that were
//! introduced between 3.14.0b1 and 3.14.3).
